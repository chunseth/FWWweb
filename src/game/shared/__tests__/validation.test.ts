...
const makeBoard = (size = 15): BoardCell[][] =>
...
describe("validateSubmitTurn", () => {
  ...
  it("rejects placed tiles in one line when they do not form a single connected word group", () => {
    ...
    board[7][6] = { id: "l", letter: "L", value: 1, scored: true };
    board[7][7] = { id: "i", letter: "I", value: 1, isFromRack: true, scored: false };
    board[10][6] = { id: "s", letter: "S", value: 1, scored: true };
    board[10][7] = { id: "u", letter: "U", value: 1, isFromRack: true, scored: false };
    board[11][6] = { id: "t", letter: "T", value: 1, scored: true };
  ...
  it("accepts placed tiles in one line when existing tiles bridge them into one connected group", () => {
    ...
    board[7][6] = { id: "l", letter: "L", value: 1, scored: true };
    board[7][7] = { id: "i", letter: "I", value: 1, isFromRack: true, scored: false };
    board[8][7] = { id: "n", letter: "N", value: 1, scored: true };
    board[9][7] = { id: "u", letter: "U", value: 1, isFromRack: true, scored: false };
    board[9][8] = { id: "s", letter: "S", value: 1, scored: true };
  ...
  it("accepts first turn when a tile is placed on the 11x11 center square", () => {
    ...
    board[5][5] = { id: "a", letter: "A", value: 1, isFromRack: true, scored: false };
    board[5][6] = { id: "t", letter: "T", value: 1, isFromRack: true, scored: false };
